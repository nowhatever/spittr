 ...
 *
 */
public class SyncNotInterruptiblyDemo {

    private Object lock;

    public SyncNotInterruptiblyDemo() {
        lock = this;
    }
    ...
    public static void main(String[] args) {
        SyncNotInterruptiblyDemo buff = new SyncNotInterruptiblyDemo();
...
class Writer extends Thread {
    ...
    private SyncNotInterruptiblyDemo buff;

    public Writer(SyncNotInterruptiblyDemo buff) {
        this.buff = buff;
    }
...
class Reader extends Thread {
    ...
    public Reader(SyncNotInterruptiblyDemo buff) {
        this.buff = buff;
    }
